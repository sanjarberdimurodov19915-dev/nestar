...
import { Types, type Model, type ObjectId } from 'mongoose';
...
export class FollowService {
    ...
    public async getMemberFollowers(memberId: ObjectId, input: FollowInquiry): Promise<Followers> {
       ...
       /*  console.log('SEARCH ID:', search?.followingId);
        const test = await this.followModel.find({
            followingId: new Types.ObjectId('6a87d0e7f62c6374468d7c51'),
        });
